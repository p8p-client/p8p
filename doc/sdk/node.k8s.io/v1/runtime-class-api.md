...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Node\V1\RuntimeClassApi`
...
```php
use P8p\Sdk\Api\Node\V1\RuntimeClassApi;

$runtimeClassApi = $client->getApi(RuntimeClassApi::class);
```
...
**Method Signature:**
```php
$runtimeClassApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Node\V1\RuntimeClassList>
```
...
**Method Signature:**
```php
$runtimeClassApi->create(
    P8p\Sdk\Schema\Node\V1\RuntimeClass $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Node\V1\RuntimeClass>
```

| `body` | `P8p\Sdk\Schema\Node\V1\RuntimeClass` |  |
