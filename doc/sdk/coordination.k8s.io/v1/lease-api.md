...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Coordination\V1\LeaseApi`
...
```php
use P8p\Sdk\Api\Coordination\V1\LeaseApi;

$leaseApi = $client->getApi(LeaseApi::class);
```
...
**Method Signature:**
```php
$leaseApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Coordination\V1\LeaseList>
```
...
$leaseApi->create(
    string $namespace,
    P8p\Sdk\Schema\Coordination\V1\Lease $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Coordination\V1\Lease>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Coordination\V1\Lease` |  |
