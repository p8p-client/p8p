...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Events\V1\EventApi`
...
```php
use P8p\Sdk\Api\Events\V1\EventApi;
...
$eventApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Events\V1\EventList>
```
...
$eventApi->create(
    string $namespace,
    P8p\Sdk\Schema\Events\V1\Event $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Events\V1\Event>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Events\V1\Event` |  |
