...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\FlowcontrolApiserver\V1\FlowSchemaApi`
...
```php
use P8p\Sdk\Api\FlowcontrolApiserver\V1\FlowSchemaApi;

$flowSchemaApi = $client->getApi(FlowSchemaApi::class);
```
