...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Certificates\V1\CertificateSigningRequestApi`
...
```php
use P8p\Sdk\Api\Certificates\V1\CertificateSigningRequestApi;

$certificateSigningRequestApi = $client->getApi(CertificateSigningRequestApi::class);
```
...
**Method Signature:**
```php
$certificateSigningRequestApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequestList>
```
...
**Method Signature:**
```php
$certificateSigningRequestApi->create(
    P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
```

| `body` | `P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest` |  |
...
**Method Signature:**
```php
$certificateSigningRequestApi->deleteCollection(
...
**Method Signature:**
```php
$certificateSigningRequestApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
```
...
**Method Signature:**
```php
$certificateSigningRequestApi->replace(
    string $name,
    P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
...
**Method Signature:**
```php
$certificateSigningRequestApi->delete(
    string $name,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Meta\V1\Status>
...
**Method Signature:**
```php
$certificateSigningRequestApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
...
**Method Signature:**
```php
$certificateSigningRequestApi->readApproval(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
```
...
**Method Signature:**
```php
$certificateSigningRequestApi->replaceApproval(
    string $name,
    P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
...
**Method Signature:**
```php
$certificateSigningRequestApi->patchApproval(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
...
**Method Signature:**
```php
$certificateSigningRequestApi->readStatus(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
```
...
**Method Signature:**
```php
$certificateSigningRequestApi->replaceStatus(
    string $name,
    P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
...
**Method Signature:**
```php
$certificateSigningRequestApi->patchStatus(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Certificates\V1\CertificateSigningRequest>
