...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\ServiceApi`
...
```php
use P8p\Sdk\Api\Core\V1\ServiceApi;

$serviceApi = $client->getApi(ServiceApi::class);
```
...
$serviceApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ServiceList>
```
...
$serviceApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\Service $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Service>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\Service` |  |
...
**Method Signature:**
```php
$serviceApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ServiceList>
```
