...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\EndpointsApi`
...
```php
use P8p\Sdk\Api\Core\V1\EndpointsApi;

$endpointsApi = $client->getApi(EndpointsApi::class);
```
...
**Method Signature:**
```php
$endpointsApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\EndpointsList>
```
...
$endpointsApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\Endpoints $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Endpoints>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\Endpoints` |  |
