...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\NamespaceK8sApi`

---

## Table of Contents

- [list](#listCoreV1Namespace)
- [create](#createCoreV1Namespace)
- [read](#readCoreV1Namespace)
- [replace](#replaceCoreV1Namespace)
- [delete](#deleteCoreV1Namespace)
- [patch](#patchCoreV1Namespace)
- [replaceFinalize](#replaceCoreV1NamespaceFinalize)
- [readStatus](#readCoreV1NamespaceStatus)
- [replaceStatus](#replaceCoreV1NamespaceStatus)
- [patchStatus](#patchCoreV1NamespaceStatus)
...
```php
use P8p\Sdk\Api\Core\V1\NamespaceK8sApi;

$namespaceK8sApi = $client->getApi(NamespaceK8sApi::class);
```
...
**Method Signature:**
```php
$namespaceK8sApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\NamespaceList>
```
...
**Method Signature:**
```php
$namespaceK8sApi->create(
    P8p\Sdk\Schema\Core\V1\NamespaceK8s $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\NamespaceK8s>
```

| `body` | `P8p\Sdk\Schema\Core\V1\NamespaceK8s` |  |
...
**Method Signature:**
```php
$namespaceK8sApi->replaceFinalize(
    string $name,
    P8p\Sdk\Schema\Core\V1\NamespaceK8s $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\NamespaceK8s>
