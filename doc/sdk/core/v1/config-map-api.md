...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\ConfigMapApi`
...
$configMapApi = $client->getApi(ConfigMapApi::class);
```
...
**Method Signature:**
```php
$configMapApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ConfigMapList>
```
...
$configMapApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ConfigMap $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ConfigMap>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\ConfigMap` |  |
