...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\BindingApi`
...
```php
use P8p\Sdk\Api\Core\V1\BindingApi;

$bindingApi = $client->getApi(BindingApi::class);
```
...
$bindingApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\Binding $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Binding>
```
...
| `body` | `P8p\Sdk\Schema\Core\V1\Binding` |  |
