...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\PodTemplateApi`
...
```php
use P8p\Sdk\Api\Core\V1\PodTemplateApi;

$podTemplateApi = $client->getApi(PodTemplateApi::class);
```
...
$podTemplateApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PodTemplateList>
```
...
**Method Signature:**
```php
$podTemplateApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\PodTemplate $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PodTemplate>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\PodTemplate` |  |
...
**Method Signature:**
```php
$podTemplateApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$podTemplateApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PodTemplateList>
```
