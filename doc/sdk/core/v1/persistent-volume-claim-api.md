...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\PersistentVolumeClaimApi`
...
```php
use P8p\Sdk\Api\Core\V1\PersistentVolumeClaimApi;

$persistentVolumeClaimApi = $client->getApi(PersistentVolumeClaimApi::class);
```
...
**Method Signature:**
```php
$persistentVolumeClaimApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolumeClaimList>
```
...
**Method Signature:**
```php
$persistentVolumeClaimApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim` |  |
...
**Method Signature:**
```php
$persistentVolumeClaimApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->replace(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim $body
    ?array $query = null,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->delete(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\DeleteOptions $body
    ?array $query = null,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->patch(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->readStatus(
    string $name,
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim>
...
**Method Signature:**
```php
$persistentVolumeClaimApi->replaceStatus(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\PersistentVolumeClaim $body
    ?array $query = null,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->patchStatus(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$persistentVolumeClaimApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolumeClaimList>
```
