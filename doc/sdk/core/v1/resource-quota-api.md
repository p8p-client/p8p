...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\ResourceQuotaApi`
...
```php
use P8p\Sdk\Api\Core\V1\ResourceQuotaApi;

$resourceQuotaApi = $client->getApi(ResourceQuotaApi::class);
```
...
**Method Signature:**
```php
$resourceQuotaApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ResourceQuotaList>
```
...
**Method Signature:**
```php
$resourceQuotaApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ResourceQuota $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ResourceQuota>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\ResourceQuota` |  |
...
**Method Signature:**
```php
$resourceQuotaApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$resourceQuotaApi->replaceStatus(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ResourceQuota $body
    ?array $query = null,
...
**Method Signature:**
```php
$resourceQuotaApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ResourceQuotaList>
```
