...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\EventApi`

---

## Table of Contents

- [listForAllNamespaces](#listCoreV1EventForAllNamespaces)
- [list](#listCoreV1NamespacedEvent)
- [create](#createCoreV1NamespacedEvent)
- [deleteCollection](#deleteCoreV1CollectionNamespacedEvent)
- [read](#readCoreV1NamespacedEvent)
- [replace](#replaceCoreV1NamespacedEvent)
- [delete](#deleteCoreV1NamespacedEvent)
- [patch](#patchCoreV1NamespacedEvent)
...
```php
use P8p\Sdk\Api\Core\V1\EventApi;

$eventApi = $client->getApi(EventApi::class);
```
...
**Method Signature:**
```php
$eventApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\EventList>
```
...
$eventApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\Event $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Event>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\Event` |  |
