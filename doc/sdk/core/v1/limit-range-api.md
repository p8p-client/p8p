...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\LimitRangeApi`
...
```php
use P8p\Sdk\Api\Core\V1\LimitRangeApi;

$limitRangeApi = $client->getApi(LimitRangeApi::class);
```
...
**Method Signature:**
```php
$limitRangeApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\LimitRangeList>
```
...
**Method Signature:**
```php
$limitRangeApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\LimitRange $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\LimitRange>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\LimitRange` |  |
...
**Method Signature:**
```php
$limitRangeApi->deleteCollection(
    string $namespace,
