...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\ReplicationControllerApi`
...
```php
use P8p\Sdk\Api\Core\V1\ReplicationControllerApi;

$replicationControllerApi = $client->getApi(ReplicationControllerApi::class);
```
...
**Method Signature:**
```php
$replicationControllerApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ReplicationControllerList>
```
...
**Method Signature:**
```php
$replicationControllerApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ReplicationController $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ReplicationController>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\ReplicationController` |  |
...
**Method Signature:**
```php
$replicationControllerApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$replicationControllerApi->replace(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ReplicationController $body
    ?array $query = null,
...
**Method Signature:**
```php
$replicationControllerApi->delete(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
...
**Method Signature:**
```php
$replicationControllerApi->patch(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$replicationControllerApi->readStatus(
    string $name,
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ReplicationController>
...
**Method Signature:**
```php
$replicationControllerApi->replaceStatus(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ReplicationController $body
    ?array $query = null,
...
**Method Signature:**
```php
$replicationControllerApi->patchStatus(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$replicationControllerApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ReplicationControllerList>
```
