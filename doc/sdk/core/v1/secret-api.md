...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\SecretApi`
...
```php
use P8p\Sdk\Api\Core\V1\SecretApi;

$secretApi = $client->getApi(SecretApi::class);
```
...
$secretApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\SecretList>
```
...
$secretApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\Secret $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Secret>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\Secret` |  |
...
**Method Signature:**
```php
$secretApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\SecretList>
```
