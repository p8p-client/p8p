...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\ServiceAccountApi`
...
```php
use P8p\Sdk\Api\Core\V1\ServiceAccountApi;

$serviceAccountApi = $client->getApi(ServiceAccountApi::class);
```
...
$serviceAccountApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ServiceAccountList>
```
...
$serviceAccountApi->create(
    string $namespace,
    P8p\Sdk\Schema\Core\V1\ServiceAccount $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ServiceAccount>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Core\V1\ServiceAccount` |  |
...
**Method Signature:**
```php
$serviceAccountApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$serviceAccountApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\ServiceAccountList>
```
