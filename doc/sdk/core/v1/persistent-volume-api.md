...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\PersistentVolumeApi`
...
```php
use P8p\Sdk\Api\Core\V1\PersistentVolumeApi;

$persistentVolumeApi = $client->getApi(PersistentVolumeApi::class);
```
...
**Method Signature:**
```php
$persistentVolumeApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolumeList>
```
...
**Method Signature:**
```php
$persistentVolumeApi->create(
    P8p\Sdk\Schema\Core\V1\PersistentVolume $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolume>
```

| `body` | `P8p\Sdk\Schema\Core\V1\PersistentVolume` |  |
...
**Method Signature:**
```php
$persistentVolumeApi->readStatus(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolume>
```
...
**Method Signature:**
```php
$persistentVolumeApi->replaceStatus(
    string $name,
    P8p\Sdk\Schema\Core\V1\PersistentVolume $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolume>
...
**Method Signature:**
```php
$persistentVolumeApi->patchStatus(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\PersistentVolume>
