...
- **API Group:** Core
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Core\V1\NodeApi`
...
```php
use P8p\Sdk\Api\Core\V1\NodeApi;

$nodeApi = $client->getApi(NodeApi::class);
```
...
$nodeApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\NodeList>
```
...
```php
$nodeApi->create(
    P8p\Sdk\Schema\Core\V1\Node $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Node>
```

| `body` | `P8p\Sdk\Schema\Core\V1\Node` |  |
