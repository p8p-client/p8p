# SelfSubjectAccessReviewApi

[← Back to Index](index.md)

- **API Group:** authorization.k8s.io
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Authorization\V1\SelfSubjectAccessReviewApi`
...
```php
use P8p\Sdk\Api\Authorization\V1\SelfSubjectAccessReviewApi;

$selfSubjectAccessReviewApi = $client->getApi(SelfSubjectAccessReviewApi::class);
```
...
**Method Signature:**
```php
$selfSubjectAccessReviewApi->create(
    P8p\Sdk\Schema\Authorization\V1\SelfSubjectAccessReview $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Authorization\V1\SelfSubjectAccessReview>
```

| `body` | `P8p\Sdk\Schema\Authorization\V1\SelfSubjectAccessReview` |  |
