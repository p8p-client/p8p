...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Authorization\V1\SubjectAccessReviewApi`

---

## Table of Contents

- [create](#createAuthorizationV1SubjectAccessReview)
...
```php
use P8p\Sdk\Api\Authorization\V1\SubjectAccessReviewApi;

$subjectAccessReviewApi = $client->getApi(SubjectAccessReviewApi::class);
```
...
**Method Signature:**
```php
$subjectAccessReviewApi->create(
    P8p\Sdk\Schema\Authorization\V1\SubjectAccessReview $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Authorization\V1\SubjectAccessReview>
```

| `body` | `P8p\Sdk\Schema\Authorization\V1\SubjectAccessReview` |  |
