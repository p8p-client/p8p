...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Authorization\V1\LocalSubjectAccessReviewApi`

---

## Table of Contents

- [create](#createAuthorizationV1NamespacedLocalSubjectAccessReview)
...
```php
use P8p\Sdk\Api\Authorization\V1\LocalSubjectAccessReviewApi;

$localSubjectAccessReviewApi = $client->getApi(LocalSubjectAccessReviewApi::class);
```
...
**Method Signature:**
```php
$localSubjectAccessReviewApi->create(
    string $namespace,
    P8p\Sdk\Schema\Authorization\V1\LocalSubjectAccessReview $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Authorization\V1\LocalSubjectAccessReview>
```
...
| `body` | `P8p\Sdk\Schema\Authorization\V1\LocalSubjectAccessReview` |  |
