...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Networking\V1\NetworkPolicyApi`
...
```php
use P8p\Sdk\Api\Networking\V1\NetworkPolicyApi;

$networkPolicyApi = $client->getApi(NetworkPolicyApi::class);
```
...
**Method Signature:**
```php
$networkPolicyApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\NetworkPolicyList>
```
...
**Method Signature:**
```php
$networkPolicyApi->create(
    string $namespace,
    P8p\Sdk\Schema\Networking\V1\NetworkPolicy $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\NetworkPolicy>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Networking\V1\NetworkPolicy` |  |
...
**Method Signature:**
```php
$networkPolicyApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$networkPolicyApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\NetworkPolicyList>
```
