...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Networking\V1\IPAddressApi`
...
```php
use P8p\Sdk\Api\Networking\V1\IPAddressApi;

$IPAddressApi = $client->getApi(IPAddressApi::class);
```
...
$IPAddressApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\IPAddressList>
```
...
```php
$IPAddressApi->create(
    P8p\Sdk\Schema\Networking\V1\IPAddress $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\IPAddress>
```

| `body` | `P8p\Sdk\Schema\Networking\V1\IPAddress` |  |
