...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Networking\V1\IngressApi`
...
```php
use P8p\Sdk\Api\Networking\V1\IngressApi;

$ingressApi = $client->getApi(IngressApi::class);
```
...
**Method Signature:**
```php
$ingressApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\IngressList>
```
...
$ingressApi->create(
    string $namespace,
    P8p\Sdk\Schema\Networking\V1\Ingress $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\Ingress>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Networking\V1\Ingress` |  |
