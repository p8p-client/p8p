...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Networking\V1\IngressClassApi`
...
```php
use P8p\Sdk\Api\Networking\V1\IngressClassApi;

$ingressClassApi = $client->getApi(IngressClassApi::class);
```
...
**Method Signature:**
```php
$ingressClassApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\IngressClassList>
```
...
**Method Signature:**
```php
$ingressClassApi->create(
    P8p\Sdk\Schema\Networking\V1\IngressClass $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Networking\V1\IngressClass>
```

| `body` | `P8p\Sdk\Schema\Networking\V1\IngressClass` |  |
...
**Method Signature:**
```php
$ingressClassApi->deleteCollection(
