...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Discovery\V1\EndpointSliceApi`
...
```php
use P8p\Sdk\Api\Discovery\V1\EndpointSliceApi;

$endpointSliceApi = $client->getApi(EndpointSliceApi::class);
```
...
**Method Signature:**
```php
$endpointSliceApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Discovery\V1\EndpointSliceList>
```
...
**Method Signature:**
```php
$endpointSliceApi->create(
    string $namespace,
    P8p\Sdk\Schema\Discovery\V1\EndpointSlice $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Discovery\V1\EndpointSlice>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Discovery\V1\EndpointSlice` |  |
