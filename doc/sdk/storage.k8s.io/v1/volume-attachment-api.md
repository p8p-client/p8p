...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Storage\V1\VolumeAttachmentApi`
...
```php
use P8p\Sdk\Api\Storage\V1\VolumeAttachmentApi;

$volumeAttachmentApi = $client->getApi(VolumeAttachmentApi::class);
```
...
**Method Signature:**
```php
$volumeAttachmentApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\VolumeAttachmentList>
```
...
**Method Signature:**
```php
$volumeAttachmentApi->create(
    P8p\Sdk\Schema\Storage\V1\VolumeAttachment $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\VolumeAttachment>
```

| `body` | `P8p\Sdk\Schema\Storage\V1\VolumeAttachment` |  |
...
**Method Signature:**
```php
$volumeAttachmentApi->readStatus(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\VolumeAttachment>
```
...
**Method Signature:**
```php
$volumeAttachmentApi->replaceStatus(
    string $name,
    P8p\Sdk\Schema\Storage\V1\VolumeAttachment $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\VolumeAttachment>
...
**Method Signature:**
```php
$volumeAttachmentApi->patchStatus(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\VolumeAttachment>
