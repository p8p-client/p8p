# CSIStorageCapacityApi

[← Back to Index](index.md)

- **API Group:** storage.k8s.io
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Storage\V1\CSIStorageCapacityApi`
...
```php
use P8p\Sdk\Api\Storage\V1\CSIStorageCapacityApi;

$CSIStorageCapacityApi = $client->getApi(CSIStorageCapacityApi::class);
```
...
**Method Signature:**
```php
$CSIStorageCapacityApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSIStorageCapacityList>
```
...
**Method Signature:**
```php
$CSIStorageCapacityApi->create(
    string $namespace,
    P8p\Sdk\Schema\Storage\V1\CSIStorageCapacity $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSIStorageCapacity>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Storage\V1\CSIStorageCapacity` |  |
...
**Method Signature:**
```php
$CSIStorageCapacityApi->deleteCollection(
    string $namespace,
