...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Storage\V1\StorageClassApi`
...
```php
use P8p\Sdk\Api\Storage\V1\StorageClassApi;

$storageClassApi = $client->getApi(StorageClassApi::class);
```
...
$storageClassApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\StorageClassList>
```
...
**Method Signature:**
```php
$storageClassApi->create(
    P8p\Sdk\Schema\Storage\V1\StorageClass $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\StorageClass>
```

| `body` | `P8p\Sdk\Schema\Storage\V1\StorageClass` |  |
