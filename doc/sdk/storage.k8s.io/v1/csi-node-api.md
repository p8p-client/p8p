...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Storage\V1\CSINodeApi`
...
```php
use P8p\Sdk\Api\Storage\V1\CSINodeApi;

$CSINodeApi = $client->getApi(CSINodeApi::class);
```
...
$CSINodeApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSINodeList>
```
...
```php
$CSINodeApi->create(
    P8p\Sdk\Schema\Storage\V1\CSINode $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSINode>
```

| `body` | `P8p\Sdk\Schema\Storage\V1\CSINode` |  |
