...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Storage\V1\CSIDriverApi`
...
```php
use P8p\Sdk\Api\Storage\V1\CSIDriverApi;

$CSIDriverApi = $client->getApi(CSIDriverApi::class);
```
...
$CSIDriverApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSIDriverList>
```
...
```php
$CSIDriverApi->create(
    P8p\Sdk\Schema\Storage\V1\CSIDriver $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Storage\V1\CSIDriver>
```

| `body` | `P8p\Sdk\Schema\Storage\V1\CSIDriver` |  |
