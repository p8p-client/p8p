...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Apiextensions\V1\CustomResourceDefinitionApi`
...
**Method Signature:**
```php
$customResourceDefinitionApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinitionList>
```
...
**Method Signature:**
```php
$customResourceDefinitionApi->create(
    P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
```

| `body` | `P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition` |  |
...
**Method Signature:**
```php
$customResourceDefinitionApi->deleteCollection(
...
**Method Signature:**
```php
$customResourceDefinitionApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
```
...
**Method Signature:**
```php
$customResourceDefinitionApi->replace(
    string $name,
    P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
...
**Method Signature:**
```php
$customResourceDefinitionApi->delete(
    string $name,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Meta\V1\Status>
...
**Method Signature:**
```php
$customResourceDefinitionApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
...
**Method Signature:**
```php
$customResourceDefinitionApi->readStatus(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
```
...
**Method Signature:**
```php
$customResourceDefinitionApi->replaceStatus(
    string $name,
    P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
...
**Method Signature:**
```php
$customResourceDefinitionApi->patchStatus(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiextensions\V1\CustomResourceDefinition>
