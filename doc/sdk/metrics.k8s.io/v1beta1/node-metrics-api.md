...
- **API Version:** v1beta1
- **Full Class Name:** `P8p\Sdk\Api\Metrics\V1beta1\NodeMetricsApi`
...
```php
use P8p\Sdk\Api\Metrics\V1beta1\NodeMetricsApi;

$nodeMetricsApi = $client->getApi(NodeMetricsApi::class);
```
...
$nodeMetricsApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Metrics\V1beta1\NodeMetricsList>
```
...
$nodeMetricsApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Metrics\V1beta1\NodeMetrics>
```
