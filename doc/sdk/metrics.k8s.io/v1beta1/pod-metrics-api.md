...
- **API Version:** v1beta1
- **Full Class Name:** `P8p\Sdk\Api\Metrics\V1beta1\PodMetricsApi`
...
```php
use P8p\Sdk\Api\Metrics\V1beta1\PodMetricsApi;

$podMetricsApi = $client->getApi(PodMetricsApi::class);
```
...
$podMetricsApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Metrics\V1beta1\PodMetricsList>
```
...
$podMetricsApi->read(
    ...
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Metrics\V1beta1\PodMetrics>
```
...
**Method Signature:**
```php
$podMetricsApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Metrics\V1beta1\PodMetricsList>
```
