...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\RbacAuthorization\V1\ClusterRoleBindingApi`
...
```php
use P8p\Sdk\Api\RbacAuthorization\V1\ClusterRoleBindingApi;

$clusterRoleBindingApi = $client->getApi(ClusterRoleBindingApi::class);
```
