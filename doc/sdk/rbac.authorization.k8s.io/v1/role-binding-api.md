...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\RbacAuthorization\V1\RoleBindingApi`
...
```php
use P8p\Sdk\Api\RbacAuthorization\V1\RoleBindingApi;

$roleBindingApi = $client->getApi(RoleBindingApi::class);
```
