# SelfSubjectReviewApi

[← Back to Index](index.md)

- **API Group:** authentication.k8s.io
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Authentication\V1\SelfSubjectReviewApi`

---

## Table of Contents

- [create](#createAuthenticationV1SelfSubjectReview)
...
```php
use P8p\Sdk\Api\Authentication\V1\SelfSubjectReviewApi;

$selfSubjectReviewApi = $client->getApi(SelfSubjectReviewApi::class);
```
...
**Method Signature:**
```php
$selfSubjectReviewApi->create(
    P8p\Sdk\Schema\Authentication\V1\SelfSubjectReview $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Authentication\V1\SelfSubjectReview>
```

| `body` | `P8p\Sdk\Schema\Authentication\V1\SelfSubjectReview` |  |
