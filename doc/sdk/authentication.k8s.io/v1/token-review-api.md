...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Authentication\V1\TokenReviewApi`
...
```php
use P8p\Sdk\Api\Authentication\V1\TokenReviewApi;

$tokenReviewApi = $client->getApi(TokenReviewApi::class);
```
...
**Method Signature:**
```php
$tokenReviewApi->create(
    P8p\Sdk\Schema\Authentication\V1\TokenReview $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Authentication\V1\TokenReview>
```

| `body` | `P8p\Sdk\Schema\Authentication\V1\TokenReview` |  |
