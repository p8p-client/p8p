...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Autoscaling\V1\HorizontalPodAutoscalerApi`

---

## Table of Contents

- [listForAllNamespaces](#listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces)
- [list](#listAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [create](#createAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [deleteCollection](#deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler)
- [read](#readAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [replace](#replaceAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [delete](#deleteAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [patch](#patchAutoscalingV1NamespacedHorizontalPodAutoscaler)
- [readStatus](#readAutoscalingV1NamespacedHorizontalPodAutoscalerStatus)
- [replaceStatus](#replaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus)
- [patchStatus](#patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus)
...
```php
use P8p\Sdk\Api\Autoscaling\V1\HorizontalPodAutoscalerApi;

$horizontalPodAutoscalerApi = $client->getApi(HorizontalPodAutoscalerApi::class);
```
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscalerList>
```
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscalerList>
```
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->create(
    string $namespace,
    P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler` |  |
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->read(
    string $name,
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler>
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->replace(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler $body
    ?array $query = null,
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->patch(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->readStatus(
    string $name,
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler>
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->replaceStatus(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Autoscaling\V1\HorizontalPodAutoscaler $body
    ?array $query = null,
...
**Method Signature:**
```php
$horizontalPodAutoscalerApi->patchStatus(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
