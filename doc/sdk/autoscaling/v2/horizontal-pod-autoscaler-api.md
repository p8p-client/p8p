...
- **API Version:** v2
- **Full Class Name:** `P8p\Sdk\Api\Autoscaling\V2\HorizontalPodAutoscalerApi`
...
```php
use P8p\Sdk\Api\Autoscaling\V2\HorizontalPodAutoscalerApi;
...
$horizontalPodAutoscalerApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscalerList>
```
...
$horizontalPodAutoscalerApi->create(
    string $namespace,
    P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscaler $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscaler>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Autoscaling\V2\HorizontalPodAutoscaler` |  |
