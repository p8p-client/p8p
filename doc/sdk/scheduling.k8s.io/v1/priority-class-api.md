...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Scheduling\V1\PriorityClassApi`
...
```php
use P8p\Sdk\Api\Scheduling\V1\PriorityClassApi;

$priorityClassApi = $client->getApi(PriorityClassApi::class);
```
...
**Method Signature:**
```php
$priorityClassApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Scheduling\V1\PriorityClassList>
```
...
**Method Signature:**
```php
$priorityClassApi->create(
    P8p\Sdk\Schema\Scheduling\V1\PriorityClass $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Scheduling\V1\PriorityClass>
```

| `body` | `P8p\Sdk\Schema\Scheduling\V1\PriorityClass` |  |
...
**Method Signature:**
```php
$priorityClassApi->deleteCollection(
