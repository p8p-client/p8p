...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Apiregistration\V1\APIServiceApi`
...
```php
use P8p\Sdk\Api\Apiregistration\V1\APIServiceApi;

$APIServiceApi = $client->getApi(APIServiceApi::class);
```
...
$APIServiceApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiregistration\V1\APIServiceList>
```
...
**Method Signature:**
```php
$APIServiceApi->create(
    P8p\Sdk\Schema\Apiregistration\V1\APIService $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apiregistration\V1\APIService>
```

| `body` | `P8p\Sdk\Schema\Apiregistration\V1\APIService` |  |
...
**Method Signature:**
```php
$APIServiceApi->deleteCollection(
