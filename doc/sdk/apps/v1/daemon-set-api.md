...
- **API Group:** apps
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Apps\V1\DaemonSetApi`
...
```php
use P8p\Sdk\Api\Apps\V1\DaemonSetApi;

$daemonSetApi = $client->getApi(DaemonSetApi::class);
```
...
**Method Signature:**
```php
$daemonSetApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\DaemonSetList>
```
...
$daemonSetApi->create(
    string $namespace,
    P8p\Sdk\Schema\Apps\V1\DaemonSet $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\DaemonSet>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Apps\V1\DaemonSet` |  |
