...
- **API Group:** apps
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Apps\V1\ReplicaSetApi`

---

## Table of Contents

- [list](#listAppsV1NamespacedReplicaSet)
- [create](#createAppsV1NamespacedReplicaSet)
- [deleteCollection](#deleteAppsV1CollectionNamespacedReplicaSet)
- [read](#readAppsV1NamespacedReplicaSet)
- [replace](#replaceAppsV1NamespacedReplicaSet)
- [delete](#deleteAppsV1NamespacedReplicaSet)
- [patch](#patchAppsV1NamespacedReplicaSet)
- [readStatus](#readAppsV1NamespacedReplicaSetStatus)
- [replaceStatus](#replaceAppsV1NamespacedReplicaSetStatus)
- [patchStatus](#patchAppsV1NamespacedReplicaSetStatus)
- [listForAllNamespaces](#listAppsV1ReplicaSetForAllNamespaces)
...
```php
use P8p\Sdk\Api\Apps\V1\ReplicaSetApi;

$replicaSetApi = $client->getApi(ReplicaSetApi::class);
```
...
$replicaSetApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\ReplicaSetList>
```
...
**Method Signature:**
```php
$replicaSetApi->create(
    string $namespace,
    P8p\Sdk\Schema\Apps\V1\ReplicaSet $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\ReplicaSet>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Apps\V1\ReplicaSet` |  |
...
**Method Signature:**
```php
$replicaSetApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$replicaSetApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\ReplicaSetList>
```
