# ControllerRevisionApi

[← Back to Index](../../index.md)

- **API Group:** apps
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Apps\V1\ControllerRevisionApi`
...
```php
use P8p\Sdk\Api\Apps\V1\ControllerRevisionApi;

$controllerRevisionApi = $client->getApi(ControllerRevisionApi::class);
```
...
**Method Signature:**
```php
$controllerRevisionApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\ControllerRevisionList>
```
...
**Method Signature:**
```php
$controllerRevisionApi->create(
    string $namespace,
    P8p\Sdk\Schema\Apps\V1\ControllerRevision $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Apps\V1\ControllerRevision>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Apps\V1\ControllerRevision` |  |
