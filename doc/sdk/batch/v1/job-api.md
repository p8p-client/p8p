...
- **API Group:** batch
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Batch\V1\JobApi`
...
```php
use P8p\Sdk\Api\Batch\V1\JobApi;

$jobApi = $client->getApi(JobApi::class);
```
...
**Method Signature:**
```php
$jobApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Batch\V1\JobList>
```
...
$jobApi->create(
    string $namespace,
    P8p\Sdk\Schema\Batch\V1\Job $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Batch\V1\Job>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Batch\V1\Job` |  |
