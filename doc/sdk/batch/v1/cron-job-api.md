...
- **API Group:** batch
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Batch\V1\CronJobApi`
...
```php
use P8p\Sdk\Api\Batch\V1\CronJobApi;

$cronJobApi = $client->getApi(CronJobApi::class);
```
...
**Method Signature:**
```php
$cronJobApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Batch\V1\CronJobList>
```
...
$cronJobApi->create(
    string $namespace,
    P8p\Sdk\Schema\Batch\V1\CronJob $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Batch\V1\CronJob>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Batch\V1\CronJob` |  |
