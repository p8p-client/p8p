...
- **API Group:** policy
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Policy\V1\PodDisruptionBudgetApi`
...
```php
use P8p\Sdk\Api\Policy\V1\PodDisruptionBudgetApi;

$podDisruptionBudgetApi = $client->getApi(PodDisruptionBudgetApi::class);
```
...
**Method Signature:**
```php
$podDisruptionBudgetApi->list(
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Policy\V1\PodDisruptionBudgetList>
```
...
**Method Signature:**
```php
$podDisruptionBudgetApi->create(
    string $namespace,
    P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget>
```
...
|------|------|-------------|
| `namespace` | `string` | object name and auth scope, such as for teams and projects |
| `body` | `P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget` |  |
...
**Method Signature:**
```php
$podDisruptionBudgetApi->deleteCollection(
    string $namespace,
...
**Method Signature:**
```php
$podDisruptionBudgetApi->replace(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget $body
    ?array $query = null,
...
**Method Signature:**
```php
$podDisruptionBudgetApi->readStatus(
    string $name,
    string $namespace,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget>
...
**Method Signature:**
```php
$podDisruptionBudgetApi->replaceStatus(
    string $name,
    string $namespace,
    P8p\Sdk\Schema\Policy\V1\PodDisruptionBudget $body
    ?array $query = null,
...
**Method Signature:**
```php
$podDisruptionBudgetApi->patchStatus(
    string $name,
    string $namespace,
    array $body
    ?array $query = null,
...
**Method Signature:**
```php
$podDisruptionBudgetApi->listForAllNamespaces(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Policy\V1\PodDisruptionBudgetList>
```
