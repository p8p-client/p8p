...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Admissionregistration\V1\ValidatingAdmissionPolicyApi`
...
```php
use P8p\Sdk\Api\Admissionregistration\V1\ValidatingAdmissionPolicyApi;

$validatingAdmissionPolicyApi = $client->getApi(ValidatingAdmissionPolicyApi::class);
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyList>
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->create(
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
```

| `body` | `P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy` |  |
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->deleteCollection(
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->replace(
    string $name,
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->delete(
    string $name,
    P8p\Sdk\Schema\Core\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Core\V1\Status>
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->readStatus(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->replaceStatus(
    string $name,
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
...
**Method Signature:**
```php
$validatingAdmissionPolicyApi->patchStatus(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicy>
