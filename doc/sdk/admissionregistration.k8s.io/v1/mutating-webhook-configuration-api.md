...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Admissionregistration\V1\MutatingWebhookConfigurationApi`
...
```php
use P8p\Sdk\Api\Admissionregistration\V1\MutatingWebhookConfigurationApi;

$mutatingWebhookConfigurationApi = $client->getApi(MutatingWebhookConfigurationApi::class);
```
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfigurationList>
```
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->create(
    P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration>
```

| `body` | `P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration` |  |
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->deleteCollection(
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration>
```
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->replace(
    string $name,
    P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration>
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->delete(
    string $name,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Meta\V1\Status>
...
**Method Signature:**
```php
$mutatingWebhookConfigurationApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\MutatingWebhookConfiguration>
