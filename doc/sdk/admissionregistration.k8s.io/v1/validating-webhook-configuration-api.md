...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Admissionregistration\V1\ValidatingWebhookConfigurationApi`

---

## Table of Contents

- [list](#listAdmissionregistrationV1ValidatingWebhookConfiguration)
- [create](#createAdmissionregistrationV1ValidatingWebhookConfiguration)
- [deleteCollection](#deleteAdmissionregistrationV1CollectionValidatingWebhookConfiguration)
- [read](#readAdmissionregistrationV1ValidatingWebhookConfiguration)
- [replace](#replaceAdmissionregistrationV1ValidatingWebhookConfiguration)
...
```php
use P8p\Sdk\Api\Admissionregistration\V1\ValidatingWebhookConfigurationApi;

$validatingWebhookConfigurationApi = $client->getApi(ValidatingWebhookConfigurationApi::class);
```
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfigurationList>
```
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->create(
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration>
```

| `body` | `P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration` |  |
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->deleteCollection(
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration>
```
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->replace(
    string $name,
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration>
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->delete(
    string $name,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Meta\V1\Status>
...
**Method Signature:**
```php
$validatingWebhookConfigurationApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingWebhookConfiguration>
