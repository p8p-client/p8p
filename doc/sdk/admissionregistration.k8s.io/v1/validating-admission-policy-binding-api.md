...
- **API Version:** v1
- **Full Class Name:** `P8p\Sdk\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBindingApi`
...
```php
use P8p\Sdk\Api\Admissionregistration\V1\ValidatingAdmissionPolicyBindingApi;

$validatingAdmissionPolicyBindingApi = $client->getApi(ValidatingAdmissionPolicyBindingApi::class);
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->list(
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBindingList>
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->create(
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding>
```

| `body` | `P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding` |  |
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->deleteCollection(
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->read(
    string $name,
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding>
```
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->replace(
    string $name,
    P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding>
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->delete(
    string $name,
    P8p\Sdk\Schema\Meta\V1\DeleteOptions $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Meta\V1\Status>
...
**Method Signature:**
```php
$validatingAdmissionPolicyBindingApi->patch(
    string $name,
    array $body
    ?array $query = null,
): Response<P8p\Sdk\Schema\Admissionregistration\V1\ValidatingAdmissionPolicyBinding>
